...
import { listRecurringRules, listTransactions } from "@/lib/db/finance";
...
export default async function Fixas() {
  ...
  const [regras, doMes] = await Promise.all([
  ...
  return (
    <>
      ...
      <p className="mt-6 text-sm text-suave">
        Eu lanço cada uma sozinho no dia certo. Se o valor mudar, é só me contar — ou
        parar essa e cadastrar de novo com o valor novo.
      </p>
    </>
  );
}
